          ...
          <div className="bg-neutralwhite absolute left-[432px] top-[176px] h-[614px] w-[576px] rounded-[20px] border border-solid border-[#c1c1c1]">
            ...
            <div className="absolute left-[59px] top-[206px] h-[74px] w-[460px]">
              <div className="bg-neutralwhite absolute left-0 top-[26px] h-[48px] w-[456px] rounded-[6px] border border-solid border-[#c1c1c1]">
                <div className="absolute left-[15px] top-[14px] whitespace-nowrap text-[16px] font-normal leading-[normal] tracking-[0] text-neutral-400 [font-family:'Inter-Regular',Helvetica]">
                  Enter
                </div>
              </div>
              <div className="absolute left-0 top-0 whitespace-nowrap text-[16px] font-medium leading-[normal] tracking-[0] text-black [font-family:'Inter-Regular',Helvetica]">
                Email
              </div>
            </div>
            <div className="absolute left-[60px] top-[313px] h-[74px] w-[460px]">
              ...
              <div className="absolute left-[400px] top-[41px] h-[19px] w-[44px]">
                <div className="relative h-[19px] w-[42px]">
                  <div className="absolute left-0 top-0 whitespace-nowrap text-[16px] font-medium leading-[normal] tracking-[0] text-black underline [font-family:'Inter-Regular',Helvetica]">
                    Show
                  </div>
            ...
            <div className="absolute left-[144px] top-[543px] h-[19px] w-[263px]">
              ...
              <div className="absolute left-[189px] top-0 h-[18px] w-[72px]">
                <div className="absolute -top-px left-0 whitespace-nowrap text-[16px] font-bold leading-[normal] tracking-[1.12px] text-black [font-family:'Inter-Medium',Helvetica]">
                  SIGN UP
                </div>
              </div>
            </div>
